    ...
    public partial class Add_Delete_Book : Form
    {
        ...
        private void button_AddBook_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source = M1TARG1\M1TARG1SQL; Initial Catalog = Library; Integrated Security = True")) // Соединение с бБД
            {
                ...
                SqlCommand checkCmd = new SqlCommand(checkQuery, connection); // Команду для выполнения запроса
                ...
                if (count > 0)
                {
                    ...
                    SqlCommand updateCmd = new SqlCommand(updateQuery, connection); // Команда для обновления
                ...
                else // Если книга не существует, добавляем новую
                {
                    ...
                    SqlCommand insertCmd = new SqlCommand(insertQuery, connection); // Команду для вставки
        ...
        private void button_DelBook_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source = M1TARG1\M1TARG1SQL; Initial Catalog = Library; Integrated Security = True")) // Создание соединения с БД
            {
                connection.Open(); // Открытие соединения с БД
                ...
                SqlCommand deleteCmd = new SqlCommand(deleteQuery, connection); // Создание команды для удаления
                ...
                connection.Close(); // Закрытие соединения с БЛ
            }            
            _libraryForm.RefreshDataGrid(_dataGridView); // Обновление данных в DataGridView на форме Library
        }
    }
